...
# CORS configuration
#
# To support the new dashboard hosted separately (e.g. on port 5173 via Vite or 3000),
# this application must allow cross‑origin requests from those origins.  The allowed
# origins list can be tailored in production to specific domains.  We permit
# credentials, all methods and headers to simplify integration.
# -----------------------------------------------------------------------------
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
